...
@WebServlet("/UserDetailsServ")
public class UserDetailsServ extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        Query<CustomerInput> query = hibernateSession.createQuery("from CustomerInput where email=:email");
        ...
        if (customerList != null && !customerList.isEmpty()) {
            ...
            out.println("<a href='RaiseComplaintServ' class='btn btn-primary ml-2'>Raise Complaint</a>"); // Raise Complaint button
            out.println("</div>");
